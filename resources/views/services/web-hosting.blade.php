...
@section('content')
    ...
    <section id="hosting-plans" class="hosting-plans section">
        <div class="container">
            <div class="section-title text-center mb-5">
                ...
                <p data-aos="fade-up" data-aos-delay="100">High-performance hosting solutions tailored to your website's
                    needs with 99.9% uptime guarantee</p>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <img src="{{ asset('assets/img/server-illustration.webp') }}" alt="Hosting Server Infrastructure"
                        class="img-fluid">
                </div>
    ...
    <section id="managed-services" class="managed-services section">
        <div class="container">
            <div class="section-title text-center mb-5">
                ...
                <p data-aos="fade-up" data-aos-delay="100">Focus on your business while we handle the technical details
                </p>
            </div>
    ...
    <section id="hosting-cta" class="hosting-cta section dark-background">
        <div class="container text-center">
            ...
            <p class="mb-4" data-aos="fade-up" data-aos-delay="100">Migrate your website for free with our expert
                assistance</p>
